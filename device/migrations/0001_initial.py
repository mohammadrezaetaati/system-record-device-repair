    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('provide_date', models.CharField(editable=False, max_length=20)),
                ...
                ('status', models.CharField(choices=[('ngoing', 'دردست اقدام'), ('finished', 'تحویل داده شده'), ('provide', 'آماده به تحویل')], max_length=8)),
